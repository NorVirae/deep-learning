...
def compute_gradient_descent_external(
    X, y, w_in=np.zeros(4), b_in=0, alpha=1.0e-1, num_iters=5000
):
...
if __name__ == "__main__":
    ...
    w_final, b_final, J_hist, p_hist = compute_gradient_descent(
        x_train,
        y_train,
        w_init,
        b_init,
    ...
    print(f"(w,b) found gradient descent: ({w_final:8.4f}, {b_final:8.4f})")
